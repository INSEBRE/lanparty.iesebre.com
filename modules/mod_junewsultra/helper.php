...
class modJUNewsUltraHelper {
	...
	function getList(&$params) {
        ...
        foreach ( $rows as $row ) {
            ...
            /*if ($dgmtips_t == 1) {
                $dgm_title_t = ' class="Tips2" title="'. $lists[$i]->text .'" ';
            } */
            ...
            if ($pik==1) {
                ...
                if ($thumb_width==1){
                    ...
                    $imgthr2 = '&amp;w='. $iW .'&amp;h='. $iH . $zc . $imgfiltr . $moreparam .'&amp;q=100';
                } else {
                    $imgfiltr = '';
                    $imgfiltr2 = '';
                }
                ...
                if ( $row->images != '' ) {
    		        ...
    		        $lists[$i]->image = $imlink .'<img src="'. $imgthr . $images . $imgthr2 .'" />'. $imlink2;
    		    } else {
    			    $regex = "/<img[^>]+src\s*=\s*[\"']\/?([^\"']+)[\"'][^>]*\>/";
    				...
    				if ( count($images) ) {
    		            $lists[$i]->image = $imlink .'<img src="'. $imgthr . $images[1] . $imgthr2 .'" />'. $imlink2;
    				}
                }
            }
