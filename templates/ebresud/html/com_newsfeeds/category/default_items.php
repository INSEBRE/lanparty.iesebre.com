...
<tr>
	<td style="text-align:center;" class="sp sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>" width="5%">
		<?php echo JText::_('Num'); ?>
	</td>
	<?php if ( $this->params->get( 'show_name' ) ) : ?>
	<td height="20" width="85%" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
