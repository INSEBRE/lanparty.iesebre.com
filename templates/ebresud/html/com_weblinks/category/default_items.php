...
<tr>
	<td style="text-align:right;" class="sp sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
...
<tr class="sectiontableentry<?php echo $item->odd + 1; ?>">
	<td align="right" class="sp">
		<strong><?php echo $this->pagination->getRowOffset( $item->count ); ?></strong>
	</td>
	<td height="20">
		<?php if ( $item->image ) : ?>
		&nbsp;&nbsp;<?php echo $item->image;?>&nbsp;&nbsp;
