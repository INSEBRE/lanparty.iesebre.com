    	...
    	<td>
        	<table class="admintable">
            	<tr>
                    ...
                    <td>
                        <a href="http://www.joomlacontenteditor.net/forum" target="_new">www.joomlacontenteditor.net/forum</a>
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <a href="http://www.joomlacontenteditor.net/support/tutorials" target="_new">www.joomlacontenteditor.net/tutorials</a>
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <a href="http://www.joomlacontenteditor.net/support/documentation" target="_new">www.joomlacontenteditor.net/documentation</a>
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <a href="http://www.joomlacontenteditor.net/support/faq" target="_new">www.joomlacontenteditor.net/faq</a>
                    </td>
                </tr>
                <tr>
                    <td class="key">
